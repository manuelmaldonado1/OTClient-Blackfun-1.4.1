...
vocationBoxIllusionist = nil
vocationBoxRogue = nil
vocationBoxShaman = nil
vocationBoxNecromancer = nil
...
FILTER_VOCATION_ILLUSIONIST = 5
FILTER_VOCATION_ROGUE = 6
FILTER_VOCATION_SHAMAN = 7
FILTER_VOCATION_NECROMANCER = 8
...
function init()
    ...
    vocationBoxIllusionist = spelllistWindow:getChildById('vocationBoxIllusionist')
    vocationBoxRogue = spelllistWindow:getChildById('vocationBoxRogue')
    vocationBoxShaman = spelllistWindow:getChildById('vocationBoxShaman')
    vocationBoxNecromancer = spelllistWindow:getChildById('vocationBoxNecromancer')
    ...
    vocationRadioGroup:addWidget(vocationBoxIllusionist)
    vocationRadioGroup:addWidget(vocationBoxRogue)
    vocationRadioGroup:addWidget(vocationBoxShaman)
    vocationRadioGroup:addWidget(vocationBoxNecromancer)
...
function toggleFilter(widget, selectedWidget)
    if widget == vocationRadioGroup then
        ...
        elseif boxId == 'vocationBoxIllusionist' then
            filters.vocationId = FILTER_VOCATION_ILLUSIONIST
        elseif boxId == 'vocationBoxRogue' then
            filters.vocationId = FILTER_VOCATION_ROGUE
        elseif boxId == 'vocationBoxShaman' then
            filters.vocationId = FILTER_VOCATION_SHAMAN
        elseif boxId == 'vocationBoxNecromancer' then
            filters.vocationId = FILTER_VOCATION_NECROMANCER
        end
